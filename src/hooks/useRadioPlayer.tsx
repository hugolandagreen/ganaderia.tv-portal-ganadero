...
const TV_STREAM_URL = `https://${import.meta.env.VITE_SUPABASE_PROJECT_ID}.supabase.co/functions/v1/hls-proxy?path=${encodeURIComponent('/iptv/channel/1.m3u8')}&mode=segmenter`;
