    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden">
      ...
      <div className="bg-gradient-to-r from-[hsl(348_55%_28%)] via-[hsl(348_50%_32%)] to-[hsl(348_55%_28%)] backdrop-blur-md shadow-[0_-4px_30px_rgba(0,0,0,0.2)]">
        <div className="container mx-auto px-4 flex items-center gap-4 h-14 md:h-14">
          <button
            onClick={togglePlay}
            className="h-10 w-10 rounded-full bg-accent flex items-center justify-center hover:bg-[hsl(var(--gold-light))] transition-all duration-300 shadow-lg glow-gold shrink-0 group"
          >
            {isPlaying ? (
          ...
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="flex flex-col min-w-0">
              <span className="text-sm font-bold text-primary-foreground truncate leading-tight">
                Radio Ganadera
              </span>
              <span className="text-[10px] font-medium text-primary-foreground/60 truncate leading-tight hidden sm:block">
                Música y noticias del campo 24/7
              </span>
            </div>
            {isPlaying && (
          ...
          <div className="flex items-center gap-2 ml-auto shrink-0">
            ...
            <div className="w-20 md:w-28 hidden sm:block">
              <Slider
                ...
                max={100}
                step={1}
                className="[&_[role=slider]]:bg-accent [&_[role=slider]]:border-accent [&_.range]:bg-accent/80"
              />
            </div>
          </div>
        </div>
