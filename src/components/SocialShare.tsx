  ...
  const shareLinks = [
    {
      ...
      color: "hover:bg-[hsl(142_70%_40%)] hover:text-white",
    },
    {
      name: "Facebook",
      icon: <Facebook className={iconSize} />,
      href: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(shareUrl)}`,
      color: "hover:bg-[hsl(220_46%_48%)] hover:text-white",
    },
    {
      name: "X (Twitter)",
    ...
    },
    {
      ...
      color: "hover:bg-[hsl(200_70%_50%)] hover:text-white",
    },
  ];
    ...
    <div className={`flex items-center gap-1.5 ${className}`}>
      {shareLinks.map((link) => (
        <a
          ...
          className={`${btnSize} rounded-full bg-muted flex items-center justify-center text-muted-foreground transition-all duration-200 ${link.color}`}
      ...
      <button
        ...
        title="Copiar enlace"
        className={`${btnSize} rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:bg-accent hover:text-accent-foreground transition-all duration-200`}
      >
