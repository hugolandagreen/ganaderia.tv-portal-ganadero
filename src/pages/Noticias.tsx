...
import { Globe, Milk, Beef, ArrowRight, ArrowLeft, Newspaper, Loader2 } from "lucide-react";
      ...
      <section className="pt-28 pb-12 bg-gradient-to-b from-primary/10 via-secondary/20 to-background relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Toda la información actualizada del sector ganadero en Latinoamérica y el mundo
          </p>
        </div>
      </section>
      ...
      <section className="py-10">
        <div className="container mx-auto px-4">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            Mostrando <span className="font-bold text-foreground">{filtered.length}</span> noticias
          </p>
